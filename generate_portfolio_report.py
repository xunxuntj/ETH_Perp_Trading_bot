...
def get_report_time_window() -> Tuple[datetime.datetime, datetime.datetime, int]:
    ...
    try:
        ...
        REPORT_START_TIME = "2026-07-29 00:00"
    ...
    try:
        ...
        print(f"⚠️ 解析 REPORT_START_TIME '{REPORT_START_TIME}' 失败: {e}，使用默认值 2026-07-29 00:00")
        dt_naive = datetime.datetime.strptime("2026-07-29 00:00", "%Y-%m-%d %H:%M")
        start_dt = dt_naive.replace(tzinfo=tz_utc8)
