#!/usr/bin/env python3
"""
Detailed Backtester and Reporter for the Optimal Joint Portfolio Strategy (ETH + SOL).
"""
...
def run_detailed_backtest():
    print("=" * 80)
    print("📈 RUNNING DETAILED BACKTEST: OPTIMAL ETH + SOL PORTFOLIO (2% RISK)")
    print("=" * 80)
    ...
    df_trades.to_csv(os.path.join(RESULTS_DIR, "portfolio_trades.csv"), index=False)
    ...
    print("\n" + "=" * 80)
    print("📋 DETAILED BACKTEST PORTFOLIO REPORT SUMMARY")
    print("=" * 80)
